...
export type IconName =
  | "check" | "x" | "warning" | "arrow-right" | "arrow-left" | "arrow-up" | "arrow-down"
  | "trash" | "edit" | "plus" | "search" | "filter" | "download" | "refresh"
  | "user" | "settings" | "bell" | "clock" | "calendar" | "chart" | "star"
  | "heart" | "lock" | "unlock" | "copy" | "eye" | "eye-off" | "info"
  | "chevron-down" | "chevron-up" | "external-link" | "menu" | "more"
  | "check-circle" | "x-circle" | "file-text" | "rocket" | "rotate-ccw"
  | "server" | "cpu" | "package" | "alert-triangle" | "user-plus"
  | "key" | "activity" | "bar-chart";
...
const iconPaths: Record<IconName, string> = {
  ...
  warning: "M12 9v4m0 4h.01M12 3l9.66 16.5H2.34L12 3z",
  "arrow-right": "M9 5l7 7-7 7",
  "arrow-left": "M15 5l-7 7 7 7",
  "arrow-up": "M5 15l7-7 7 7",
  "arrow-down": "M5 9l7 7 7-7",
  trash: "M4 6h16M7 6V4a1 1 0 011-1h8a1 1 0 011 1v2M10 11v6M14 11v6M5 6l1 14h12l1-14",
  ...
  calendar: "M4 5a2 2 0 012-2h12a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V5zM16 3v4M8 3v4M4 11h16M8 15h.01M12 15h.01M16 15h.01M8 19h.01M12 19h.01M16 19h.01",
  ...
  "x-circle": "M15 9l-6 6M9 9l6 6M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2s10 4.477 10 10z",
  "file-text": "M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8zM16 2v6h6M16 13H8M16 17H8M10 9H8",
  ...
  cpu: "M9.5 2v2.5M14.5 2v2.5M9.5 19.5V22M14.5 19.5V22M4 9.5H2M4 14.5H2M22 9.5h-2M22 14.5h-2M6 6h12v12H6V6z",
